...
const styles = StyleSheet.create({
  ...
  quoteText:{color:'rgba(255,255,230,0.95)',fontSize:17,fontStyle:'italic',textAlign:'center',lineHeight:28,fontWeight:'700'},
  ...
  questionText:{color:'rgba(255,255,255,0.92)',fontSize:15,lineHeight:26,textAlign:'center'},
