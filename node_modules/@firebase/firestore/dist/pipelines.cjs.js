...
=======
    const s = commonAbf03211.__PRIVATE_isString(t) ? __PRIVATE_valueToDefaultExpr$1(t.toLowerCase()) : t;
>>>>>>> main
...
=======
                    direction: commonAbf03211.__PRIVATE_toStringValue(this.direction),
>>>>>>> main
...
=======
    return t.selectable && commonAbf03211.__PRIVATE_isString(t.alias) && __PRIVATE_isExpr(t.expr);
>>>>>>> main
}
...
=======
    return commonAbf03211.__PRIVATE_isString(t.alias) && t.aggregate instanceof AggregateFunction;
>>>>>>> main
}
...
=======
    if (e instanceof commonAbf03211.FieldFilter) {
>>>>>>> main
...
=======
            return and(t.exists(), t.notEqual(Constant._fromProto(n)));
>>>>>>> main
...
=======
                return e ? 1 === e.length ? and(t.exists(), t.notEqual(e[0])) : and(t.exists(), t.notEqualAny(e)) : and(t.exists(), t.notEqualAny([]));
            }

          default:
            commonAbf03211.fail(36935);
        }
    } else if (e instanceof commonAbf03211.CompositeFilter) switch (e.op) {
>>>>>>> main
...
=======
    n = commonAbf03211.__PRIVATE_isCollectionGroupQuery(e) ? t.pipeline().collectionGroup(e.collectionGroup) : commonAbf03211.__PRIVATE_isDocumentQuery$1(e) ? t.pipeline().documents([ commonAbf03211.doc(t, e.path.canonicalString()) ]) : t.pipeline().collection(e.path.canonicalString());
    // filters
        for (const t of e.filters) n = n.where(__PRIVATE_toPipelineBooleanExpr(t));
    // orders
        const r = commonAbf03211.__PRIVATE_queryNormalizedOrderBy(e), s = r.map((e => field(e.field.canonicalString()).exists()));
    n = s.length > 1 ? n.where(and(s[0], s[1], ...s.slice(2))) : n.where(s[0]);
>>>>>>> main
...
=======
        return new commonAbf03211.OptionsUtil({});
>>>>>>> main
    }
    constructor(e, t) {
...
=======
            args: [ commonAbf03211.__PRIVATE_toMapValue(e, this.fields) ]
>>>>>>> main
        };
    }
    _readUserData(e) {
...
=======
            args: [ commonAbf03211.__PRIVATE_toMapValue(e, this.accumulators), commonAbf03211.__PRIVATE_toMapValue(e, this.groups) ]
>>>>>>> main
        };
    }
    _readUserData(e) {
...
=======
            args: [ commonAbf03211.__PRIVATE_toMapValue(e, this.groups) ]
>>>>>>> main
        };
    }
    _readUserData(e) {
...
=======
            args: [ this.field._toProto(e), this.vectorValue._toProto(e), commonAbf03211.__PRIVATE_toStringValue(this.distanceMeasure) ]
>>>>>>> main
        };
    }
    _readUserData(e) {
...
=======
    ...
    constructor(e, t) {
        commonAbf03211.__PRIVATE_hardAssert(!isNaN(e) && e !== 1 / 0 && e !== -1 / 0, 34860), super(t), this.limit = e;
>>>>>>> main
    }
    /**
     * @internal
...
=======
            args: [ commonAbf03211.toNumber(e, this.limit) ]
>>>>>>> main
        };
    }
}
...
=======
            args: [ commonAbf03211.toNumber(e, this.offset) ]
>>>>>>> main
        };
    }
}
...
=======
            args: [ commonAbf03211.__PRIVATE_toMapValue(e, this.selections) ]
>>>>>>> main
        };
    }
    _readUserData(e) {
...
=======
            args: [ commonAbf03211.toNumber(e, this.rate), commonAbf03211.__PRIVATE_toStringValue(this.mode) ]
>>>>>>> main
        };
    }
    _readUserData(e) {
...
=======
            args: [ commonAbf03211.__PRIVATE_toPipelineValue(this.other._toProto(e)) ]
>>>>>>> main
        };
    }
    _readUserData(e) {
...
=======
            args: [ this.map._toProto(e), commonAbf03211.__PRIVATE_toStringValue(__PRIVATE_Replace._) ]
>>>>>>> main
        };
    }
    _readUserData(e) {
...
=======
    return commonAbf03211.__PRIVATE_isUserData(e) ? e._readUserData(t) : Array.isArray(e) ? e.forEach((e => e._readUserData(t))) : e.forEach((e => e._readUserData(t))), 
>>>>>>> main
    e;
}
...
=======
        const t = commonAbf03211.__PRIVATE_isString(e) || commonAbf03211.__PRIVATE_isCollectionReference(e) ? {} : e, r = commonAbf03211.__PRIVATE_isString(e) || commonAbf03211.__PRIVATE_isCollectionReference(e) ? e : e.collection;
        // Validate that a user provided reference is for the same Firestore DB
        commonAbf03211.__PRIVATE_isCollectionReference(r) && this._validateReference(r);
        // Convert user land convenience types to internal types
                const s = commonAbf03211.__PRIVATE_isString(r) ? r : r.path, i = new __PRIVATE_CollectionSource(s, t), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "collection");
>>>>>>> main
        // Create stage object
...
=======
        commonAbf03211.__PRIVATE_isString(e) ? (t = e, r = {}) : ({collectionId: t, ...r} = e);
>>>>>>> main
        // Create stage object
...
=======
        r.filter((e => e instanceof commonAbf03211.DocumentReference)).forEach((e => this._validateReference(e)));
        // Convert user land convenience types to internal types
        const s = r.map((e => commonAbf03211.__PRIVATE_isString(e) ? e : e.path)), i = new __PRIVATE_DocumentsSource(s, t), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "documents");
>>>>>>> main
        // Create stage object
                // Add stage to the pipeline
        return i._readUserData(o), this._createPipeline([ i ]);
...
=======
        if (!n.isEqual(this.databaseId)) throw new commonAbf03211.FirestoreError(commonAbf03211.C.INVALID_ARGUMENT, `Invalid ${e instanceof commonAbf03211.CollectionReference ? "CollectionReference" : "DocumentReference"}. The project ID ("${n.projectId}") or the database ("${n.database}") does not match the project ID ("${this.databaseId.projectId}") and database ("${this.databaseId.database}") of the target database of this Pipeline.`);
>>>>>>> main
    }
}
...
=======
        const t = this._fields.field(commonAbf03211.__PRIVATE_fieldPathFromArgument("DocumentSnapshot.get", e));
>>>>>>> main
...
=======
    return e === t || commonAbf03211.__PRIVATE_isOptionalEqual(e._ref, t._ref, commonAbf03211.refEqual) && commonAbf03211.__PRIVATE_isOptionalEqual(e._fields, t._fields, ((e, t) => e.isEqual(t)));
>>>>>>> main
}
...
=======
        s = r.expr) : commonAbf03211.fail(21273, {
            selectable: r
        }), void 0 !== n.get(e)) throw new commonAbf03211.FirestoreError("invalid-argument", `Duplicate alias or field '${e}'`);
>>>>>>> main
        n.set(e, s);
    }
    return n;
...
=======
    if (commonAbf03211.__PRIVATE_isString(t)) {
>>>>>>> main
        return field(t);
    }
    /**
...
=======
        n = commonAbf03211.__PRIVATE_isPlainObject(t) ? map(t) : t instanceof Array ? array(t) : __PRIVATE__constant(t, void 0);
>>>>>>> main
        return n;
    }
    /**
...
=======
        const r = __PRIVATE_isField(e) || commonAbf03211.__PRIVATE_isString(e) ? {} : e, s = (__PRIVATE_isField(e) || commonAbf03211.__PRIVATE_isString(e) ? [ e, ...t ] : e.fields).map((e => commonAbf03211.__PRIVATE_isString(e) ? field(e) : e)), i = new __PRIVATE_RemoveFields(s, r);
>>>>>>> main
        // Add stage to the pipeline
        // User data must be read in the context of the API method to
        // provide contextual errors
...
=======
        const r = __PRIVATE_isSelectable(e) || commonAbf03211.__PRIVATE_isString(e) ? {} : e, s = __PRIVATE_selectablesToMap(__PRIVATE_isSelectable(e) || commonAbf03211.__PRIVATE_isString(e) ? [ e, ...t ] : e.selections), i = new __PRIVATE_Select(s, r), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "select");
>>>>>>> main
        // Add stage to the pipeline
        return i._readUserData(o), this._addStage(i);
    }
...
=======
        commonAbf03211.__PRIVATE_isNumber$1(e) ? (t = {}, n = e) : (t = e, n = e.offset);
>>>>>>> main
        // Create stage object
...
=======
        const t = commonAbf03211.__PRIVATE_isNumber$1(e) ? {} : e, n = commonAbf03211.__PRIVATE_isNumber$1(e) ? e : e.limit, r = new __PRIVATE_Limit(n, t), s = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "limit");
>>>>>>> main
        // Add stage to the pipeline
        return r._readUserData(s), this._addStage(r);
    }
...
=======
        const r = commonAbf03211.__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? {} : e, s = __PRIVATE_selectablesToMap(commonAbf03211.__PRIVATE_isString(e) || __PRIVATE_isSelectable(e) ? [ e, ...t ] : e.groups), i = new __PRIVATE_Distinct(s, r), o = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "distinct");
>>>>>>> main
        // Add stage to the pipeline
        return i._readUserData(o), this._addStage(i);
    }
...
=======
                if (void 0 !== e.get(n.alias)) throw new commonAbf03211.FirestoreError("invalid-argument", `Duplicate alias or field '${n.alias}'`);
>>>>>>> main
...
=======
        const t = commonAbf03211.__PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? {} : e, r = __PRIVATE_fieldOrExpression(commonAbf03211.__PRIVATE_isString(e) || __PRIVATE_isExpr(e) ? e : e.map), s = new __PRIVATE_Replace(r, t), i = this.userDataReader.createContext(3 /* UserDataSource.Argument */ , "replaceWith");
>>>>>>> main
        // Add stage to the pipeline
        return s._readUserData(i), this._addStage(s);
    }
...
=======
        const t = commonAbf03211.__PRIVATE_isNumber$1(e) ? {} : e;
        let n, r;
        commonAbf03211.__PRIVATE_isNumber$1(e) ? (n = e, r = "documents") : commonAbf03211.__PRIVATE_isNumber$1(e.documents) ? (n = e.documents, r = "documents") : (n = e.percentage, 
>>>>>>> main
        r = "percent");
        // Create stage object
...
=======
        commonAbf03211.__PRIVATE_isString(i) && (r.indexField = _field(i, "unnest"));
>>>>>>> main
        // Create stage object
...
=======
        const s = n.map((t => t instanceof Expression || t instanceof AggregateFunction ? t : commonAbf03211.__PRIVATE_isPlainObject(t) ? function __PRIVATE__mapValue(e) {
>>>>>>> main
            const t = new Map;
...
=======
    } : e, {pipeline: n, rawOptions: r, ...s} = t, i = commonAbf03211.__PRIVATE_cast(n._db, commonAbf03211.Firestore), o = commonAbf03211.ensureFirestoreConfigured(i), a = new commonAbf03211.UserDataReader(i._databaseId, 
    /* ignoreUndefinedProperties */ !0).createContext(3 /* UserDataSource.Argument */ , "execute"), u = new commonAbf03211.__PRIVATE_StructuredPipelineOptions(s, r);
    u._readUserData(a);
    const _ = new commonAbf03211.StructuredPipeline(n, u);
    return commonAbf03211.__PRIVATE_firestoreClientExecutePipeline(o, _).then((e => {
        // Get the execution time from the first result.
        // firestoreClientExecutePipeline returns at least one PipelineStreamElement
        // even if the returned document set is empty.
        const t = e.length > 0 ? e[0].executionTime?.toTimestamp() : void 0, r = e.filter((e => !!e.fields)).map((e => new PipelineResult(n._userDataWriter, e.fields, e.key?.path ? new commonAbf03211.DocumentReference(i, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
>>>>>>> main
...
=======
commonAbf03211.Firestore.prototype.pipeline = function() {
    const e = commonAbf03211.__PRIVATE_newUserDataReader(this);
    return new PipelineSource(this._databaseId, e, (t => new Pipeline(this, e, new commonAbf03211.__PRIVATE_ExpUserDataWriter(this), t)));
};

exports._internalPipelineToExecutePipelineRequestProto = commonAbf03211._internalPipelineToExecutePipelineRequestProto;
>>>>>>> main
