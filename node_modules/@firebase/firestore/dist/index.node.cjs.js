...
=======
var common948f0202_node = require('./common-60e0349e.node.cjs.js');
>>>>>>> main
...
=======
    common948f0202_node.setSDKVersion(app.SDK_VERSION);
    app._registerComponent(new component.Component('firestore', (container, { instanceIdentifier: databaseId, options: settings }) => {
        const app = container.getProvider('app').getImmediate();
        const firestoreInstance = new common948f0202_node.Firestore(new common948f0202_node.FirebaseAuthCredentialsProvider(container.getProvider('auth-internal')), new common948f0202_node.FirebaseAppCheckTokenProvider(app, container.getProvider('app-check-internal')), common948f0202_node.databaseIdFromApp(app, databaseId), app);
>>>>>>> main
...
=======
        const dataClone = new common948f0202_node.ObjectValue({
>>>>>>> main
...
=======
        return new common948f0202_node.DocumentReference(this._firestore, this._converter, this._key);
>>>>>>> main
    }
    /**
...
=======
            const value = this._document.data.field(common948f0202_node.fieldPathFromArgument('DocumentSnapshot.get', fieldPath));
>>>>>>> main
            if (value !== null) {
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.UNIMPLEMENTED, 'limitToLast() queries require specifying at least one orderBy() clause');
>>>>>>> main
    }
}
/**
...
=======
        return new common948f0202_node.Query(query.firestore, query.converter, common948f0202_node.queryWithAddedFilter(query._query, filter));
    }
    _parse(query) {
        const reader = common948f0202_node.newUserDataReader(query.firestore);
>>>>>>> main
...
=======
    const field = common948f0202_node.fieldPathFromArgument('where', fieldPath);
>>>>>>> main
...
=======
        return common948f0202_node.CompositeFilter.create(parsedFilters, this._getOperator());
>>>>>>> main
    }
    _apply(query) {
...
=======
        return new common948f0202_node.Query(query.firestore, query.converter, common948f0202_node.queryWithAddedFilter(query._query, parsedFilter));
>>>>>>> main
    }
...
=======
        return new common948f0202_node.Query(query.firestore, query.converter, common948f0202_node.queryWithAddedOrderBy(query._query, orderBy));
>>>>>>> main
    }
}
/**
...
=======
    const path = common948f0202_node.fieldPathFromArgument('orderBy', fieldPath);
>>>>>>> main
...
=======
        return new common948f0202_node.Query(query.firestore, query.converter, common948f0202_node.queryWithLimit(query._query, this._limit, this._limitType));
>>>>>>> main
    }
}
/**
...
=======
    common948f0202_node.validatePositiveNumber('limit', limit);
>>>>>>> main
...
=======
    common948f0202_node.validatePositiveNumber('limitToLast', limit);
>>>>>>> main
...
=======
        return new common948f0202_node.Query(query.firestore, query.converter, common948f0202_node.queryWithStartAt(query._query, bound));
>>>>>>> main
    }
}
...
=======
        return new common948f0202_node.Query(query.firestore, query.converter, common948f0202_node.queryWithEndAt(query._query, bound));
>>>>>>> main
    }
}
...
=======
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Invalid Query. You can't perform '${op}' queries on documentId().`);
>>>>>>> main
        }
...
=======
        fieldValue = common948f0202_node.parseQueryValue(dataReader, methodName, value, 
        /* allowArrays= */ op === "in" /* Operator.IN */ || op === "not-in" /* Operator.NOT_IN */);
    }
    const filter = common948f0202_node.FieldFilter.create(fieldPath, op, fieldValue);
>>>>>>> main
    return filter;
}
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'Invalid query. You must not call startAt() or startAfter() before ' +
            'calling orderBy().');
    }
    if (query.endAt !== null) {
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'Invalid query. You must not call endAt() or endBefore() before ' +
            'calling orderBy().');
    }
    const orderBy = new common948f0202_node.OrderBy(fieldPath, direction);
>>>>>>> main
    return orderBy;
}
/**
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ` +
>>>>>>> main
            `${methodName}().`);
    }
    const components = [];
...
=======
    for (const orderBy of common948f0202_node.queryNormalizedOrderBy(query)) {
        if (orderBy.field.isKeyField()) {
            components.push(common948f0202_node.refValue(databaseId, doc.key));
        }
        else {
            const value = doc.data.field(orderBy.field);
            if (common948f0202_node.isServerTimestamp(value)) {
                throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a ' +
>>>>>>> main
...
=======
    return new common948f0202_node.Bound(components, inclusive);
>>>>>>> main
}
/**
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Too many arguments provided to ${methodName}(). ` +
>>>>>>> main
...
=======
                throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ` +
                    `${methodName}(), but got a ${typeof rawValue}`);
            }
            if (!common948f0202_node.isCollectionGroupQuery(query) && rawValue.indexOf('/') !== -1) {
                throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), ` +
                    `the value passed to ${methodName}() must be a plain document ID, but ` +
                    `'${rawValue}' contains a slash.`);
            }
            const path = query.path.child(common948f0202_node.ResourcePath.fromString(rawValue));
            if (!common948f0202_node.DocumentKey.isDocumentKey(path)) {
                throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by ` +
>>>>>>> main
...
<<<<<<< HEAD
    ...
    return new common0ccd15e0_node.Bound(components, inclusive);
=======
            const key = new common948f0202_node.DocumentKey(path);
            components.push(common948f0202_node.refValue(databaseId, key));
        }
        else {
            const wrapped = common948f0202_node.parseQueryValue(dataReader, methodName, rawValue);
            components.push(wrapped);
        }
    }
    return new common948f0202_node.Bound(components, inclusive);
...
=======
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'Invalid query. When querying with documentId(), you ' +
                'must provide a valid document ID, but it was an empty string.');
        }
        if (!common948f0202_node.isCollectionGroupQuery(query) && documentIdValue.indexOf('/') !== -1) {
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection by ` +
                `documentId(), you must provide a plain document ID, but ` +
                `'${documentIdValue}' contains a '/' character.`);
        }
        const path = query.path.child(common948f0202_node.ResourcePath.fromString(documentIdValue));
        if (!common948f0202_node.DocumentKey.isDocumentKey(path)) {
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Invalid query. When querying a collection group by ` +
                `documentId(), the value provided must result in a valid document path, ` +
                `but '${path}' is not because it has an odd number of segments (${path.length}).`);
        }
        return common948f0202_node.refValue(databaseId, new common948f0202_node.DocumentKey(path));
    }
    else if (documentIdValue instanceof common948f0202_node.DocumentReference) {
        return common948f0202_node.refValue(databaseId, documentIdValue._key);
    }
    else {
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid ` +
            `string or a DocumentReference, but it was: ` +
            `${common948f0202_node.valueDescription(documentIdValue)}.`);
>>>>>>> main
    }
}
/**
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'Invalid Query. A non-empty array is required for ' +
>>>>>>> main
...
=======
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'Invalid query. You cannot use more than one ' +
                `'${fieldFilter.op.toString()}' filter.`);
        }
        else {
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Invalid query. You cannot use '${fieldFilter.op.toString()}' filters ` +
>>>>>>> main
...
=======
        testQuery = common948f0202_node.queryWithAddedFilter(testQuery, subFilter);
>>>>>>> main
    }
}
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Function ${functionName}() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'.`);
>>>>>>> main
    }
}
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'InvalidQuery. When using composite filters, you cannot use ' +
>>>>>>> main
...
=======
class LiteUserDataWriter extends common948f0202_node.AbstractUserDataWriter {
>>>>>>> main
...
=======
        return new common948f0202_node.Bytes(bytes);
    }
    convertReference(name) {
        const key = this.convertDocumentKey(name, this.firestore._databaseId);
        return new common948f0202_node.DocumentReference(this.firestore, /* converter= */ null, key);
>>>>>>> main
    }
}
...
=======
    return new AggregateField('sum', common948f0202_node.fieldPathFromArgument('sum', field));
>>>>>>> main
}
/**
...
=======
    return new AggregateField('avg', common948f0202_node.fieldPathFromArgument('average', field));
>>>>>>> main
}
/**
...
=======
    return (common948f0202_node.queryEqual(left.query, right.query) && util.deepEqual(left.data(), right.data()));
>>>>>>> main
}
...
=======
    const firestore = common948f0202_node.cast(query.firestore, common948f0202_node.Firestore);
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    const internalAggregates = common948f0202_node.mapToArray(aggregateSpec, (aggregate, alias) => {
        return new common948f0202_node.AggregateImpl(alias, aggregate.aggregateType, aggregate._internalFieldPath);
    });
    // Run the aggregation and convert the results
    return common948f0202_node.firestoreClientRunAggregateQuery(client, query._query, internalAggregates).then(aggregateResult => convertToAggregateQuerySnapshot(firestore, query, aggregateResult));
>>>>>>> main
}
/**
...
=======
    const userDataWriter = new common948f0202_node.ExpUserDataWriter(firestore);
>>>>>>> main
...
=======
        this._onlineComponentProvider = common948f0202_node.OnlineComponentProvider.provider;
>>>>>>> main
...
=======
                build: () => new common948f0202_node.LruGcMemoryOfflineComponentProvider(undefined)
>>>>>>> main
            };
        }
    }
...
=======
        this._offlineComponentProvider = common948f0202_node.MemoryOfflineComponentProvider.provider;
>>>>>>> main
    }
    toJSON() {
        return { kind: this.kind };
...
=======
            build: () => new common948f0202_node.LruGcMemoryOfflineComponentProvider(cacheSize)
>>>>>>> main
        };
    }
    toJSON() {
...
=======
        this._onlineComponentProvider = common948f0202_node.OnlineComponentProvider.provider;
        this._offlineComponentProvider = {
            build: (onlineComponents) => new common948f0202_node.IndexedDbOfflineComponentProvider(onlineComponents, settings?.cacheSizeBytes, this.forceOwnership)
>>>>>>> main
        };
    }
}
...
=======
        this._onlineComponentProvider = common948f0202_node.OnlineComponentProvider.provider;
        this._offlineComponentProvider = {
            build: (onlineComponents) => new common948f0202_node.MultiTabOfflineComponentProvider(onlineComponents, settings?.cacheSizeBytes)
>>>>>>> main
        };
    }
}
...
=======
const encoder = common948f0202_node.newTextEncoder();
>>>>>>> main
...
=======
        this.latestReadTime = new common948f0202_node.Timestamp(0, 0);
        this.databaseId = firestore._databaseId;
        // useProto3Json is true because the objects will be serialized to JSON string
        // before being written to the bundle buffer.
        this.serializer = new common948f0202_node.JsonProtoSerializer(this.databaseId, 
        /*useProto3Json=*/ true);
        this.userDataReader = new common948f0202_node.UserDataReader(this.databaseId, true, this.serializer);
>>>>>>> main
    }
    /**
...
=======
            ? common948f0202_node.fromTimestamp(originalDocument.metadata.readTime)
>>>>>>> main
            : null;
...
=======
                    name: common948f0202_node.toName(this.serializer, docBundleData.documentKey),
                    readTime: !!docReadTime
                        ? common948f0202_node.toTimestamp(this.serializer, docReadTime) // Convert Timestamp to proto format.
>>>>>>> main
                        : undefined,
...
=======
        let latestReadTime = new common948f0202_node.Timestamp(0, 0);
>>>>>>> main
...
=======
        const queryTarget = common948f0202_node.toQueryTarget(this.serializer, common948f0202_node.queryToTarget(queryBundleData.query));
>>>>>>> main
        const bundledQuery = {
...
=======
            readTime: common948f0202_node.toTimestamp(this.serializer, latestReadTime)
>>>>>>> main
        });
    }
    /**
...
=======
        const proto3Fields = common948f0202_node.parseObject(docBundleData.documentData, context);
        return {
            name: common948f0202_node.toName(this.serializer, docBundleData.documentKey),
            fields: proto3Fields.mapValue.fields,
            updateTime: common948f0202_node.toTimestamp(this.serializer, docBundleData.versionTime),
            createTime: common948f0202_node.toTimestamp(this.serializer, docBundleData.createdTime)
>>>>>>> main
        };
    }
    /**
...
=======
            createTime: common948f0202_node.toTimestamp(this.serializer, this.latestReadTime),
>>>>>>> main
...
=======
    const builder = new BundleBuilder(db, common948f0202_node.AutoId.newId());
>>>>>>> main
...
=======
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.FAILED_PRECONDITION, 'DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. ' +
>>>>>>> main
...
=======
    type: common948f0202_node.property('string', DocumentSnapshot._jsonSchemaVersion),
    bundleSource: common948f0202_node.property('string', 'DocumentSnapshot'),
    bundleName: common948f0202_node.property('string'),
    bundle: common948f0202_node.property('string')
};
function documentSnapshotFromJSON(db, json, converter) {
    if (common948f0202_node.validateJSON(json, DocumentSnapshot._jsonSchema)) {
        if (json.bundle === NOT_SUPPORTED) {
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'The provided JSON object was created in a client environment, which is not supported.');
        }
        // Parse the bundle data.
        const serializer = common948f0202_node.newSerializer(db._databaseId);
        const bundleReader = common948f0202_node.createBundleReaderSync(json.bundle, serializer);
        const elements = bundleReader.getElements();
        const bundleLoader = new common948f0202_node.BundleLoader(bundleReader.getMetadata(), serializer);
>>>>>>> main
...
=======
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Expected bundle data to contain 1 document, but it contains ${bundledDocuments.length} documents.`);
        }
        // Build out the internal document data.
        const document = common948f0202_node.fromDocument(serializer, bundledDocuments[0].document);
        const documentKey = new common948f0202_node.DocumentKey(common948f0202_node.ResourcePath.fromString(json.bundleName));
>>>>>>> main
...
=======
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'To include metadata changes with your document changes, you must ' +
>>>>>>> main
...
=======
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.FAILED_PRECONDITION, 'QuerySnapshot.toJSON() attempted to serialize a document with pending writes. ' +
>>>>>>> main
                'Await waitForPendingWrites() before invoking toJSON().');
        }
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
=======
        result['bundleName'] = common948f0202_node.AutoId.newId();
>>>>>>> main
...
function querySnapshotFromJSON(db, json, converter) {
    if (common0ccd15e0_node.validateJSON(json, QuerySnapshot._jsonSchema)) {
        ...
        const bundleLoader = new common0ccd15e0_node.BundleLoader(bundleReader.getMetadata(), serializer);
=======
    type: common948f0202_node.property('string', QuerySnapshot._jsonSchemaVersion),
    bundleSource: common948f0202_node.property('string', 'QuerySnapshot'),
    bundleName: common948f0202_node.property('string'),
    bundle: common948f0202_node.property('string')
};
function querySnapshotFromJSON(db, json, converter) {
    if (common948f0202_node.validateJSON(json, QuerySnapshot._jsonSchema)) {
        if (json.bundle === NOT_SUPPORTED) {
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'The provided JSON object was created in a client environment, which is not supported.');
        }
        // Parse the bundle data.
...
=======
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Snapshot data expected 1 query but found ${bundleLoader.queries.length} queries.`);
        }
        // Create an internal Query object from the named query in the bundle.
        const query = common948f0202_node.fromBundledQuery(bundleLoader.queries[0].bundledQuery);
        // Construct the arrays of document data for the query.
        const bundledDocuments = bundleLoader.documents;
        let documentSet = new common948f0202_node.DocumentSet();
        bundledDocuments.map(bundledDocument => {
            const document = common948f0202_node.fromDocument(serializer, bundledDocument.document);
            documentSet = documentSet.add(document);
        });
        // Create a view snapshot of the query and documents.
        const viewSnapshot = common948f0202_node.ViewSnapshot.fromInitialDocuments(query, documentSet, common948f0202_node.documentKeySet() /* Zero mutated keys signifies no pending writes. */, 
        /* fromCache= */ false, 
        /* hasCachedResults= */ false);
        // Create an external Query object, required to construct the QuerySnapshot.
        const externalQuery = new common948f0202_node.Query(db, converter ? converter : null, query);
>>>>>>> main
...
=======
            return common948f0202_node.fail(0xf03d, { type });
>>>>>>> main
    }
}
...
=======
            common948f0202_node.queryEqual(left.query, right.query) &&
>>>>>>> main
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'Max attempts must be at least 1');
>>>>>>> main
    }
}
...
=======
        this._dataReader = common948f0202_node.newUserDataReader(_firestore);
>>>>>>> main
    }
...
=======
        const parsed = common948f0202_node.parseSetData(this._dataReader, 'WriteBatch.set', ref._key, convertedValue, ref.converter !== null, options);
        this._mutations.push(parsed.toMutation(ref._key, common948f0202_node.Precondition.none()));
>>>>>>> main
        return this;
    }
...
=======
            fieldOrUpdateData instanceof common948f0202_node.FieldPath) {
            parsed = common948f0202_node.parseUpdateVarargs(this._dataReader, 'WriteBatch.update', ref._key, fieldOrUpdateData, value, moreFieldsAndValues);
        }
        else {
            parsed = common948f0202_node.parseUpdateData(this._dataReader, 'WriteBatch.update', ref._key, fieldOrUpdateData);
        }
        this._mutations.push(parsed.toMutation(ref._key, common948f0202_node.Precondition.exists(true)));
>>>>>>> main
        return this;
    }
    /**
...
=======
        this._mutations = this._mutations.concat(new common948f0202_node.DeleteMutation(ref._key, common948f0202_node.Precondition.none()));
>>>>>>> main
        return this;
    }
    /**
...
=======
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.FAILED_PRECONDITION, 'A write batch can no longer be used after commit() ' +
>>>>>>> main
                'has been called.');
        }
    }
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'Provided document reference is from a different Firestore instance.');
>>>>>>> main
    }
    else {
        return documentRef;
...
=======
                return common948f0202_node.fail(0x5de9);
>>>>>>> main
            }
            const doc = docs[0];
...
=======
                throw common948f0202_node.fail(0x4801, {
>>>>>>> main
                    doc
                });
            }
...
=======
        const parsed = common948f0202_node.parseSetData(this._dataReader, 'Transaction.set', ref._key, convertedValue, ref.converter !== null, options);
>>>>>>> main
...
=======
            fieldOrUpdateData instanceof common948f0202_node.FieldPath) {
            parsed = common948f0202_node.parseUpdateVarargs(this._dataReader, 'Transaction.update', ref._key, fieldOrUpdateData, value, moreFieldsAndValues);
        }
        else {
            parsed = common948f0202_node.parseUpdateData(this._dataReader, 'Transaction.update', ref._key, fieldOrUpdateData);
>>>>>>> main
        }
...
=======
        const userDataWriter = new common948f0202_node.ExpUserDataWriter(this._firestore);
>>>>>>> main
        return super
            .get(documentRef)
...
=======
    firestore = common948f0202_node.cast(firestore, common948f0202_node.Firestore);
>>>>>>> main
...
=======
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    return common948f0202_node.firestoreClientTransaction(client, internalTransaction => updateFunction(new Transaction(firestore, internalTransaction)), optionsWithDefaults);
>>>>>>> main
}
...
=======
    reference = common948f0202_node.cast(reference, common948f0202_node.DocumentReference);
    const firestore = common948f0202_node.cast(reference.firestore, common948f0202_node.Firestore);
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    return common948f0202_node.firestoreClientGetDocumentViaSnapshotListener(client, reference._key).then(snapshot => convertToDocSnapshot(firestore, reference, snapshot));
>>>>>>> main
}
/**
...
=======
    ...
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new common948f0202_node.ExpUserDataWriter(firestore);
    return common948f0202_node.firestoreClientGetDocumentFromLocalCache(client, reference._key).then(doc => new DocumentSnapshot(firestore, userDataWriter, reference._key, doc, new SnapshotMetadata(doc !== null && doc.hasLocalMutations, 
>>>>>>> main
...
=======
    ...
    const firestore = common948f0202_node.cast(reference.firestore, common948f0202_node.Firestore);
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    return common948f0202_node.firestoreClientGetDocumentViaSnapshotListener(client, reference._key, {
>>>>>>> main
        source: 'server'
...
=======
    query = common948f0202_node.cast(query, common948f0202_node.Query);
    const firestore = common948f0202_node.cast(query.firestore, common948f0202_node.Firestore);
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new common948f0202_node.ExpUserDataWriter(firestore);
    validateHasExplicitOrderByForLimitToLast(query._query);
    return common948f0202_node.firestoreClientGetDocumentsViaSnapshotListener(client, query._query).then(snapshot => new QuerySnapshot(firestore, userDataWriter, query, snapshot));
>>>>>>> main
}
/**
...
=======
    ...
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new common948f0202_node.ExpUserDataWriter(firestore);
    return common948f0202_node.firestoreClientGetDocumentsFromLocalCache(client, query._query).then(snapshot => new QuerySnapshot(firestore, userDataWriter, query, snapshot));
>>>>>>> main
}
/**
...
=======
    ...
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    const userDataWriter = new common948f0202_node.ExpUserDataWriter(firestore);
    return common948f0202_node.firestoreClientGetDocumentsViaSnapshotListener(client, query._query, {
>>>>>>> main
        source: 'server'
...
=======
    ...
    const firestore = common948f0202_node.cast(reference.firestore, common948f0202_node.Firestore);
    const convertedValue = applyFirestoreDataConverter(reference.converter, data, options);
    const dataReader = common948f0202_node.newUserDataReader(firestore);
    const parsed = common948f0202_node.parseSetData(dataReader, 'setDoc', reference._key, convertedValue, reference.converter !== null, options);
    const mutation = parsed.toMutation(reference._key, common948f0202_node.Precondition.none());
    return executeWrite(firestore, [mutation]);
}
function updateDoc(reference, fieldOrUpdateData, value, ...moreFieldsAndValues) {
    reference = common948f0202_node.cast(reference, common948f0202_node.DocumentReference);
...
=======
        fieldOrUpdateData instanceof common948f0202_node.FieldPath) {
        parsed = common948f0202_node.parseUpdateVarargs(dataReader, 'updateDoc', reference._key, fieldOrUpdateData, value, moreFieldsAndValues);
    }
    else {
        parsed = common948f0202_node.parseUpdateData(dataReader, 'updateDoc', reference._key, fieldOrUpdateData);
    }
    const mutation = parsed.toMutation(reference._key, common948f0202_node.Precondition.exists(true));
>>>>>>> main
    return executeWrite(firestore, [mutation]);
}
/**
...
=======
    const firestore = common948f0202_node.cast(reference.firestore, common948f0202_node.Firestore);
    const mutations = [new common948f0202_node.DeleteMutation(reference._key, common948f0202_node.Precondition.none())];
>>>>>>> main
...
=======
    const firestore = common948f0202_node.cast(reference.firestore, common948f0202_node.Firestore);
    const docRef = common948f0202_node.doc(reference);
    const convertedValue = applyFirestoreDataConverter(reference.converter, data);
    const dataReader = common948f0202_node.newUserDataReader(reference.firestore);
    const parsed = common948f0202_node.parseSetData(dataReader, 'addDoc', docRef._key, convertedValue, reference.converter !== null, {});
    const mutation = parsed.toMutation(docRef._key, common948f0202_node.Precondition.exists(false));
>>>>>>> main
...
=======
    if (reference instanceof common948f0202_node.DocumentReference) {
        firestore = common948f0202_node.cast(reference.firestore, common948f0202_node.Firestore);
        internalQuery = common948f0202_node.newQueryForPath(reference._key.path);
>>>>>>> main
        observer = {
            next: snapshot => {
                if (args[currArg]) {
...
<<<<<<< HEAD
        ...
        const userDataWriter = new common0ccd15e0_node.ExpUserDataWriter(firestore);
=======
        const query = common948f0202_node.cast(reference, common948f0202_node.Query);
        firestore = common948f0202_node.cast(query.firestore, common948f0202_node.Firestore);
        internalQuery = query._query;
        const userDataWriter = new common948f0202_node.ExpUserDataWriter(firestore);
>>>>>>> main
        observer = {
...
=======
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    return common948f0202_node.firestoreClientListen(client, internalQuery, internalOptions, observer);
>>>>>>> main
}
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, json.error);
>>>>>>> main
    }
    let curArg = 0;
...
function onSnapshotsInSync(firestore, arg) {
    ...
    const client = common0ccd15e0_node.ensureFirestoreConfigured(firestore);
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `unsupported bundle source: ${json.bundleSource}`);
    }
}
function onSnapshotsInSync(firestore, arg) {
    firestore = common948f0202_node.cast(firestore, common948f0202_node.Firestore);
...
=======
    return common948f0202_node.firestoreClientAddSnapshotsInSyncListener(client, observer);
>>>>>>> main
}
/**
...
=======
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    return common948f0202_node.firestoreClientWrite(client, mutations);
>>>>>>> main
}
/**
...
=======
    const loadTask = common948f0202_node.loadBundle(db, json.bundle);
    loadTask
        .then(() => {
        if (!unsubscribed) {
            const docReference = new common948f0202_node.DocumentReference(db, converter ? converter : null, common948f0202_node.DocumentKey.fromPath(json.bundleName));
>>>>>>> main
...
=======
    const loadTask = common948f0202_node.loadBundle(db, json.bundle);
    loadTask
        .then(() => common948f0202_node.namedQuery(db, json.bundleName))
>>>>>>> main
        .then(query => {
...
=======
    firestore = common948f0202_node.cast(firestore, common948f0202_node.Firestore);
    common948f0202_node.ensureFirestoreConfigured(firestore);
>>>>>>> main
...
=======
        common948f0202_node.logWarn('Cannot enable indexes when persistence is disabled');
        return Promise.resolve();
    }
    const parsedIndexes = parseIndexes(jsonOrConfiguration);
    return common948f0202_node.firestoreClientSetIndexConfiguration(client, parsedIndexes);
>>>>>>> main
}
...
=======
                    const fieldPath = common948f0202_node.fieldPathFromDotSeparatedString('setIndexConfiguration', fieldPathString);
                    if (field.arrayConfig === 'CONTAINS') {
                        segments.push(new common948f0202_node.IndexSegment(fieldPath, 2 /* IndexKind.CONTAINS */));
                    }
                    else if (field.order === 'ASCENDING') {
                        segments.push(new common948f0202_node.IndexSegment(fieldPath, 0 /* IndexKind.ASCENDING */));
                    }
                    else if (field.order === 'DESCENDING') {
                        segments.push(new common948f0202_node.IndexSegment(fieldPath, 1 /* IndexKind.DESCENDING */));
                    }
                }
            }
            parsedIndexes.push(new common948f0202_node.FieldIndex(common948f0202_node.FieldIndex.UNKNOWN_ID, collectionGroup, segments, common948f0202_node.IndexState.empty()));
>>>>>>> main
        }
    }
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'Failed to parse JSON: ' + e?.message);
>>>>>>> main
    }
}
...
=======
        throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, 'Missing string value for: ' + property);
>>>>>>> main
    }
...
=======
    const client = common948f0202_node.ensureFirestoreConfigured(indexManager._firestore);
    const promise = common948f0202_node.firestoreClientDeleteAllFieldIndexes(client);
    promise
        .then(_ => common948f0202_node.logDebug('deleting all persistent cache indexes succeeded'))
        .catch(error => common948f0202_node.logWarn('deleting all persistent cache indexes failed', error));
}
function setPersistentCacheIndexAutoCreationEnabled(indexManager, isEnabled) {
    const client = common948f0202_node.ensureFirestoreConfigured(indexManager._firestore);
    const promise = common948f0202_node.firestoreClientSetPersistentCacheIndexAutoCreationEnabled(client, isEnabled);
    promise
        .then(_ => common948f0202_node.logDebug(`setting persistent cache index auto creation ` +
        `isEnabled=${isEnabled} succeeded`))
        .catch(error => common948f0202_node.logWarn(`setting persistent cache index auto creation ` +
>>>>>>> main
...
=======
            common948f0202_node.setTestingHooksSpi(testingHooksSpiImplInstance);
>>>>>>> main
        }
...
=======
exports.AbstractUserDataWriter = common948f0202_node.AbstractUserDataWriter;
exports.Bytes = common948f0202_node.Bytes;
exports.CACHE_SIZE_UNLIMITED = common948f0202_node.CACHE_SIZE_UNLIMITED;
exports.CollectionReference = common948f0202_node.CollectionReference;
exports.DocumentReference = common948f0202_node.DocumentReference;
exports.FieldPath = common948f0202_node.FieldPath;
exports.FieldValue = common948f0202_node.FieldValue;
exports.Firestore = common948f0202_node.Firestore;
exports.FirestoreError = common948f0202_node.FirestoreError;
exports.GeoPoint = common948f0202_node.GeoPoint;
exports.LoadBundleTask = common948f0202_node.LoadBundleTask;
exports.Query = common948f0202_node.Query;
exports.Timestamp = common948f0202_node.Timestamp;
exports.VectorValue = common948f0202_node.VectorValue;
exports._AutoId = common948f0202_node.AutoId;
exports._ByteString = common948f0202_node.ByteString;
exports._DatabaseId = common948f0202_node.DatabaseId;
exports._DocumentKey = common948f0202_node.DocumentKey;
exports._EmptyAppCheckTokenProvider = common948f0202_node.EmptyAppCheckTokenProvider;
exports._EmptyAuthCredentialsProvider = common948f0202_node.EmptyAuthCredentialsProvider;
exports._FieldPath = common948f0202_node.FieldPath$1;
exports._cast = common948f0202_node.cast;
exports._debugAssert = common948f0202_node.debugAssert;
exports._internalAggregationQueryToProtoRunAggregationQueryRequest = common948f0202_node._internalAggregationQueryToProtoRunAggregationQueryRequest;
exports._internalQueryToProtoQueryTarget = common948f0202_node._internalQueryToProtoQueryTarget;
exports._isBase64Available = common948f0202_node.isBase64Available;
exports._logWarn = common948f0202_node.logWarn;
exports._validateIsNotUsedTogether = common948f0202_node.validateIsNotUsedTogether;
exports.arrayRemove = common948f0202_node.arrayRemove;
exports.arrayUnion = common948f0202_node.arrayUnion;
exports.clearIndexedDbPersistence = common948f0202_node.clearIndexedDbPersistence;
exports.collection = common948f0202_node.collection;
exports.collectionGroup = common948f0202_node.collectionGroup;
exports.connectFirestoreEmulator = common948f0202_node.connectFirestoreEmulator;
exports.deleteField = common948f0202_node.deleteField;
exports.disableNetwork = common948f0202_node.disableNetwork;
exports.doc = common948f0202_node.doc;
exports.documentId = common948f0202_node.documentId;
exports.enableIndexedDbPersistence = common948f0202_node.enableIndexedDbPersistence;
exports.enableMultiTabIndexedDbPersistence = common948f0202_node.enableMultiTabIndexedDbPersistence;
exports.enableNetwork = common948f0202_node.enableNetwork;
exports.ensureFirestoreConfigured = common948f0202_node.ensureFirestoreConfigured;
exports.getFirestore = common948f0202_node.getFirestore;
exports.increment = common948f0202_node.increment;
exports.initializeFirestore = common948f0202_node.initializeFirestore;
exports.loadBundle = common948f0202_node.loadBundle;
exports.namedQuery = common948f0202_node.namedQuery;
exports.queryEqual = common948f0202_node.queryEqual;
exports.refEqual = common948f0202_node.refEqual;
exports.serverTimestamp = common948f0202_node.serverTimestamp;
exports.setLogLevel = common948f0202_node.setLogLevel;
exports.terminate = common948f0202_node.terminate;
exports.vector = common948f0202_node.vector;
exports.waitForPendingWrites = common948f0202_node.waitForPendingWrites;
>>>>>>> main
