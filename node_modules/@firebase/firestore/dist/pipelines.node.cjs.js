...
=======
    if ('fields' in obj && (obj.fields === null || common948f0202_node.isPlainObject(obj.fields))) {
>>>>>>> main
        return true;
    }
    return false;
...
=======
    else if (common948f0202_node.isPlainObject(value)) {
>>>>>>> main
        result = _map(value);
    }
...
=======
    else if (value instanceof common948f0202_node.VectorValue) {
        return constant(value);
    }
    else if (Array.isArray(value)) {
        return constant(common948f0202_node.vector(value));
>>>>>>> main
    }
    else {
...
=======
    if (common948f0202_node.isString(value)) {
>>>>>>> main
...
=======
            throw new common948f0202_node.FirestoreError('invalid-argument', `Conversion of type ${typeof this} to BooleanExpression not supported.`);
>>>>>>> main
        }
    }
    subtract(subtrahend) {
...
=======
        const internalGranularity = common948f0202_node.isString(granularity)
>>>>>>> main
...
=======
        if (common948f0202_node.DOCUMENT_KEY_NAME === nameOrPath) {
            return new Field(common948f0202_node.documentId()._internalPath, methodName);
        }
        return new Field(common948f0202_node.fieldPathFromArgument('field', nameOrPath), methodName);
>>>>>>> main
    }
    else {
...
=======
        common948f0202_node.hardAssert(this._protoValue !== undefined, 0x00ed);
>>>>>>> main
...
=======
            this._protoValue = common948f0202_node.parseData(this.value, context);
>>>>>>> main
        }
    }
}
...
=======
        return common948f0202_node.toMapValue(serializer, this.plainObject);
>>>>>>> main
    }
}
/**
...
=======
                    direction: common948f0202_node.toStringValue(this.direction),
>>>>>>> main
...
=======
    return (candidate.selectable && common948f0202_node.isString(candidate.alias) && isExpr(candidate.expr));
>>>>>>> main
}
...
=======
    return (common948f0202_node.isString(candidate.alias) &&
>>>>>>> main
...
=======
    if (f instanceof common948f0202_node.FieldFilter) {
>>>>>>> main
...
=======
                return and(fieldValue.exists(), fieldValue.notEqual(Constant._fromProto(value)));
>>>>>>> main
...
=======
            ...
            default:
                common948f0202_node.fail(0x9047);
        }
    }
    else if (f instanceof common948f0202_node.CompositeFilter) {
>>>>>>> main
        switch (f.op) {
...
=======
                common948f0202_node.fail(0x89ea);
>>>>>>> main
        }
    }
...
=======
    if (common948f0202_node.isCollectionGroupQuery(query)) {
        pipeline = db.pipeline().collectionGroup(query.collectionGroup);
    }
    else if (common948f0202_node.isDocumentQuery$1(query)) {
        pipeline = db.pipeline().documents([common948f0202_node.doc(db, query.path.canonicalString())]);
>>>>>>> main
    }
    else {
...
=======
    const orders = common948f0202_node.queryNormalizedOrderBy(query);
...
=======
        return new common948f0202_node.OptionsUtil({});
>>>>>>> main
    }
...
=======
            args: [common948f0202_node.toMapValue(serializer, this.fields)]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
                common948f0202_node.toMapValue(serializer, this.accumulators),
                common948f0202_node.toMapValue(serializer, this.groups)
>>>>>>> main
            ]
        };
    }
...
=======
            args: [common948f0202_node.toMapValue(serializer, this.groups)]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
                common948f0202_node.toStringValue(this.distanceMeasure)
>>>>>>> main
            ]
        };
    }
...
=======
    ...
    constructor(limit, options) {
        common948f0202_node.hardAssert(!isNaN(limit) && limit !== Infinity && limit !== -Infinity, 0x882c);
>>>>>>> main
        super(options);
        this.limit = limit;
    }
...
=======
            args: [common948f0202_node.toNumber(serializer, this.limit)]
>>>>>>> main
        };
    }
}
...
=======
            args: [common948f0202_node.toNumber(serializer, this.offset)]
>>>>>>> main
        };
    }
}
...
=======
            args: [common948f0202_node.toMapValue(serializer, this.selections)]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
            args: [common948f0202_node.toNumber(serializer, this.rate), common948f0202_node.toStringValue(this.mode)]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
            args: [common948f0202_node.toPipelineValue(this.other._toProto(serializer))]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
            args: [this.map._toProto(serializer), common948f0202_node.toStringValue(Replace.MODE)]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
    if (common948f0202_node.isUserData(expressionMap)) {
>>>>>>> main
...
=======
        const options = common948f0202_node.isString(collectionOrOptions) ||
            common948f0202_node.isCollectionReference(collectionOrOptions)
            ? {}
            : collectionOrOptions;
        const collectionRefOrString = common948f0202_node.isString(collectionOrOptions) ||
            common948f0202_node.isCollectionReference(collectionOrOptions)
            ? collectionOrOptions
            : collectionOrOptions.collection;
        // Validate that a user provided reference is for the same Firestore DB
        if (common948f0202_node.isCollectionReference(collectionRefOrString)) {
            this._validateReference(collectionRefOrString);
        }
        // Convert user land convenience types to internal types
        const normalizedCollection = common948f0202_node.isString(collectionRefOrString)
>>>>>>> main
...
=======
        if (common948f0202_node.isString(collectionIdOrOptions)) {
>>>>>>> main
...
=======
            .filter(v => v instanceof common948f0202_node.DocumentReference)
            .forEach(dr => this._validateReference(dr));
        // Convert user land convenience types to internal types
        const normalizedDocs = docs.map(doc => common948f0202_node.isString(doc) ? doc : doc.path);
>>>>>>> main
        // Create stage object
...
=======
            throw new common948f0202_node.FirestoreError(common948f0202_node.Code.INVALID_ARGUMENT, `Invalid ${reference instanceof common948f0202_node.CollectionReference
>>>>>>> main
                ? 'CollectionReference'
                : 'DocumentReference'}. ` +
...
=======
        const value = this._fields.field(common948f0202_node.fieldPathFromArgument('DocumentSnapshot.get', fieldPath));
>>>>>>> main
        if (value !== null) {
...
=======
    return (common948f0202_node.isOptionalEqual(left._ref, right._ref, common948f0202_node.refEqual) &&
        common948f0202_node.isOptionalEqual(left._fields, right._fields, (l, r) => l.isEqual(r)));
>>>>>>> main
}
...
=======
            common948f0202_node.fail(0x5319, { selectable });
        }
        if (result.get(alias) !== undefined) {
            throw new common948f0202_node.FirestoreError('invalid-argument', `Duplicate alias or field '${alias}'`);
>>>>>>> main
        }
...
=======
            throw new common948f0202_node.FirestoreError('invalid-argument', `Duplicate alias or field '${selectable.alias}'`);
>>>>>>> main
        }
...
=======
        const result = constant(common948f0202_node.vector(value));
>>>>>>> main
        return result;
    }
    else {
...
=======
        const options = isField(fieldValueOrOptions) || common948f0202_node.isString(fieldValueOrOptions)
            ? {}
            : fieldValueOrOptions;
        const fields = isField(fieldValueOrOptions) || common948f0202_node.isString(fieldValueOrOptions)
            ? [fieldValueOrOptions, ...additionalFields]
            : fieldValueOrOptions.fields;
        // Convert user land convenience types to internal types
        const convertedFields = fields.map(f => common948f0202_node.isString(f) ? field(f) : f);
>>>>>>> main
        // Create stage object
...
=======
        const options = isSelectable(selectionOrOptions) || common948f0202_node.isString(selectionOrOptions)
            ? {}
            : selectionOrOptions;
        const selections = isSelectable(selectionOrOptions) || common948f0202_node.isString(selectionOrOptions)
>>>>>>> main
...
=======
        if (common948f0202_node.isNumber$1(offsetOrOptions)) {
>>>>>>> main
            options = {};
            offset = offsetOrOptions;
        }
...
=======
        const options = common948f0202_node.isNumber$1(limitOrOptions) ? {} : limitOrOptions;
        const limit = common948f0202_node.isNumber$1(limitOrOptions)
>>>>>>> main
            ? limitOrOptions
...
=======
        const options = common948f0202_node.isString(groupOrOptions) || isSelectable(groupOrOptions)
            ? {}
            : groupOrOptions;
        const groups = common948f0202_node.isString(groupOrOptions) || isSelectable(groupOrOptions)
>>>>>>> main
...
=======
        const options = common948f0202_node.isString(valueOrOptions) || isExpr(valueOrOptions) ? {} : valueOrOptions;
        const fieldNameOrExpr = common948f0202_node.isString(valueOrOptions) || isExpr(valueOrOptions)
>>>>>>> main
            ? valueOrOptions
            : valueOrOptions.map;
        // Convert user land convenience types to internal types
...
=======
        const options = common948f0202_node.isNumber$1(documentsOrOptions) ? {} : documentsOrOptions;
        let rate;
        let mode;
        if (common948f0202_node.isNumber$1(documentsOrOptions)) {
            rate = documentsOrOptions;
            mode = 'documents';
        }
        else if (common948f0202_node.isNumber$1(documentsOrOptions.documents)) {
>>>>>>> main
...
=======
        if (common948f0202_node.isString(indexFieldName)) {
>>>>>>> main
...
=======
    const firestore = common948f0202_node.cast(pipeline._db, common948f0202_node.Firestore);
    const client = common948f0202_node.ensureFirestoreConfigured(firestore);
    const udr = new common948f0202_node.UserDataReader(firestore._databaseId, 
    /* ignoreUndefinedProperties */ true);
    const context = udr.createContext(3 /* UserDataSource.Argument */, 'execute');
    const structuredPipelineOptions = new common948f0202_node.StructuredPipelineOptions(rest, rawOptions);
    structuredPipelineOptions._readUserData(context);
    const structuredPipeline = new common948f0202_node.StructuredPipeline(pipeline, structuredPipelineOptions);
    return common948f0202_node.firestoreClientExecutePipeline(client, structuredPipeline).then(result => {
>>>>>>> main
...
=======
            ? new common948f0202_node.DocumentReference(firestore, null, element.key)
>>>>>>> main
...
=======
common948f0202_node.Firestore.prototype.pipeline = function () {
    const userDataReader = common948f0202_node.newUserDataReader(this);
    return new PipelineSource(this._databaseId, userDataReader, (stages) => {
        return new Pipeline(this, userDataReader, new common948f0202_node.ExpUserDataWriter(this), stages);
    });
};

exports._internalPipelineToExecutePipelineRequestProto = common948f0202_node._internalPipelineToExecutePipelineRequestProto;
>>>>>>> main
