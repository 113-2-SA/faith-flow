...
<<<<<<< HEAD
import { _ as r, a as o, F as h, b as c, c as u, d as l, O as _, e as f, f as d, g, h as m, i as p, j as w, q as y, k as P, l as D, m as b, P as v, n as k, o as O, p as S, r as C, s as x, C as j, t as z, u as tt, D as et, v as st, S as it, w as rt, x as nt, y as ot, z as ht, A as ct } from "./common-c78a0fa7.rn.esm.js";
...
=======
import { _ as r, a as o, F as h, b as c, c as u, d as l, O as _, e as f, f as d, g, h as m, i as p, j as w, q as y, k as P, l as D, m as b, P as v, n as k, o as O, p as S, r as C, s as x, C as j, t as z, u as tt, D as et, v as st, S as it, w as rt, x as nt, y as ot, z as ht, A as ct } from "./common-9e9492a0.rn.esm.js";
 ...
 */ function getAggregate(t, e) {
    const s = f(t.firestore, h), i = d(s), a = g(e, ((t, e) => new __PRIVATE_AggregateImpl(e, t.aggregateType, t._internalFieldPath)));
...
class __PRIVATE_TransactionRunner {
    constructor(t, e, s, i, a) {
        ...
        this.deferred = a, this.P = s.maxAttempts, this.I = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */);
    }
    ...
    v(t) {
        this.P > 0 && this.k(t) ? (this.P -= 1, this.asyncQueue.enqueueAndForget((() => (this.D(), 
...
class __PRIVATE_AsyncQueueImpl {
    constructor(t = Promise.resolve()) {
        ...
        this.I = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.W = () => {
            const t = getDocument();
            t && r(dt, "Visibility state changed to " + t.visibilityState), this.I.T();
        }, this.L = t;
        const e = getDocument();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.W);
    }
    get isShuttingDown() {
        return this.q;
    }
    ...
    enterRestrictedMode(t) {
        if (!this.q) {
            this.q = !0, this.M = t || !1;
            const e = getDocument();
            e && "function" == typeof e.removeEventListener && e.removeEventListener("visibilitychange", this.W);
        }
    }
    enqueue(t) {
        if (this.$(), this.q) 
        ...
        return this.U((() => this.q && this.M ? Promise.resolve() : (t().then(e.resolve, e.reject), 
        e.promise))).then((() => e.promise));
    }
    enqueueRetryable(t) {
        this.enqueueAndForget((() => (this.B.push(t), this.j())));
    }
    /**
     ...
     */    async j() {
        if (0 !== this.B.length) {
            try {
                await this.B[0](), this.B.shift(), this.I.reset();
            } catch (t) {
 ...
 */ (t)) throw t;
 // Failure will be handled by AsyncQueue
                                r(dt, "Operation failed with retryable error: " + t);
            }
            this.B.length > 0 && 
    ...
    U(t) {
        const e = this.L.then((() => (this.C = !0, t().catch((t => {
            this.S = t, this.C = !1;
