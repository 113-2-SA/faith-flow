...
<<<<<<< HEAD
    ...
    return __PRIVATE_invokeRunAggregationQueryRpc(i, t._query, r).then((e => function __PRIVATE_convertToAggregateQuerySnapshot(t, e, s) {
        ...
        return r;
=======
    const s = __PRIVATE_cast(t.firestore, Firestore), i = __PRIVATE_getDatastore(s), a = __PRIVATE_mapToArray(e, ((t, e) => new __PRIVATE_AggregateImpl(e, t.aggregateType, t._internalFieldPath)));
    // Run the aggregation and convert the results
    return __PRIVATE_invokeRunAggregationQueryRpc(i, t._query, a).then((e => function __PRIVATE_convertToAggregateQuerySnapshot(t, e, s) {
        const i = new __PRIVATE_LiteUserDataWriter(t), a = new AggregateQuerySnapshot(e, i, s);
        return a;
>>>>>>> main
    }
    /**
...
=======
        const i = __PRIVATE_validateReference(t, this._firestore), a = __PRIVATE_applyFirestoreDataConverter(i.converter, e, s), r = __PRIVATE_parseSetData(this._dataReader, "WriteBatch.set", i._key, a, null !== i.converter, s);
        return this._mutations.push(r.toMutation(i._key, Precondition.none())), this;
    }
    update(t, e, s, ...i) {
        this._verifyNotCommitted();
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "WriteBatch.update", a._key, e, s, i) : __PRIVATE_parseUpdateData(this._dataReader, "WriteBatch.update", a._key, e), 
        this._mutations.push(r.toMutation(a._key, Precondition.exists(!0))), this;
>>>>>>> main
    }
    /**
...
=======
        const i = __PRIVATE_validateReference(t, this._firestore), a = __PRIVATE_applyFirestoreDataConverter(i.converter, e, s), r = __PRIVATE_parseSetData(this._dataReader, "Transaction.set", i._key, a, null !== i.converter, s);
    ...
    update(t, e, s, ...i) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = getModularInstance(e)) || e instanceof FieldPath ? __PRIVATE_parseUpdateVarargs(this._dataReader, "Transaction.update", a._key, e, s, i) : __PRIVATE_parseUpdateData(this._dataReader, "Transaction.update", a._key, e), 
...
=======
    const i = __PRIVATE_getDatastore(t), a = {
>>>>>>> main
        ...dt,
        ...s
    };
...
=======
        const i = t.getProvider("app").getImmediate(), a = new Firestore(new __PRIVATE_LiteAuthCredentialsProvider(t.getProvider("auth-internal")), new __PRIVATE_LiteAppCheckTokenProvider(i, t.getProvider("app-check-internal")), __PRIVATE_databaseIdFromApp(i, e), i);
