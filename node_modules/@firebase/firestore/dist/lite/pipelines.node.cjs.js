...
=======
        const knownOptions = commonAb023dca_node.ObjectValue.empty();
>>>>>>> main
...
=======
                    if (optionDefinition.nestedOptions && commonAb023dca_node.isPlainObject(optionValue)) {
>>>>>>> main
...
=======
                        protoValue = commonAb023dca_node.parseData(optionValue, context) ?? undefined;
                    }
                    if (protoValue) {
                        knownOptions.set(commonAb023dca_node.FieldPath$1.fromServerFormat(optionDefinition.serverName), protoValue);
>>>>>>> main
                    }
                }
            }
...
=======
            const optionsMap = new Map(commonAb023dca_node.mapToArray(optionsOverride, (value, key) => [
                commonAb023dca_node.FieldPath$1.fromServerFormat(key),
                value !== undefined ? commonAb023dca_node.parseData(value, context) : null
>>>>>>> main
            ]));
...
=======
    if ('fields' in obj && (obj.fields === null || commonAb023dca_node.isPlainObject(obj.fields))) {
>>>>>>> main
        return true;
    }
    return false;
...
=======
    else if (commonAb023dca_node.isPlainObject(value)) {
>>>>>>> main
        result = _map(value);
    }
...
=======
    else if (value instanceof commonAb023dca_node.VectorValue) {
        return constant(value);
    }
    else if (Array.isArray(value)) {
        return constant(commonAb023dca_node.vector(value));
>>>>>>> main
    }
    else {
...
=======
    if (commonAb023dca_node.isString(value)) {
>>>>>>> main
...
=======
            throw new commonAb023dca_node.FirestoreError('invalid-argument', `Conversion of type ${typeof this} to BooleanExpression not supported.`);
>>>>>>> main
        }
    }
    subtract(subtrahend) {
...
=======
        const internalGranularity = commonAb023dca_node.isString(granularity)
>>>>>>> main
...
=======
        if (commonAb023dca_node.DOCUMENT_KEY_NAME === nameOrPath) {
            return new Field(commonAb023dca_node.documentId()._internalPath, methodName);
        }
        return new Field(commonAb023dca_node.fieldPathFromArgument('field', nameOrPath), methodName);
>>>>>>> main
    }
    else {
...
=======
        commonAb023dca_node.hardAssert(this._protoValue !== undefined, 0x00ed);
>>>>>>> main
...
=======
            this._protoValue = commonAb023dca_node.parseData(this.value, context);
>>>>>>> main
        }
    }
}
...
=======
        return commonAb023dca_node.toMapValue(serializer, this.plainObject);
>>>>>>> main
    }
}
/**
...
=======
                    direction: commonAb023dca_node.toStringValue(this.direction),
>>>>>>> main
...
=======
    return (candidate.selectable && commonAb023dca_node.isString(candidate.alias) && isExpr(candidate.expr));
>>>>>>> main
}
...
=======
    return (commonAb023dca_node.isString(candidate.alias) &&
>>>>>>> main
...
=======
    if (f instanceof commonAb023dca_node.FieldFilter) {
>>>>>>> main
...
=======
            ...
            default:
                commonAb023dca_node.fail(0x9047);
        }
    }
    else if (f instanceof commonAb023dca_node.CompositeFilter) {
>>>>>>> main
        switch (f.op) {
...
=======
                commonAb023dca_node.fail(0x89ea);
>>>>>>> main
        }
    }
...
=======
    if (commonAb023dca_node.isCollectionGroupQuery(query)) {
        pipeline = db.pipeline().collectionGroup(query.collectionGroup);
    }
    else if (commonAb023dca_node.isDocumentQuery(query)) {
        pipeline = db.pipeline().documents([commonAb023dca_node.doc(db, query.path.canonicalString())]);
>>>>>>> main
    }
    else {
...
=======
    const orders = commonAb023dca_node.queryNormalizedOrderBy(query);
...
=======
            args: [commonAb023dca_node.toMapValue(serializer, this.fields)]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
                commonAb023dca_node.toMapValue(serializer, this.accumulators),
                commonAb023dca_node.toMapValue(serializer, this.groups)
>>>>>>> main
            ]
        };
    }
...
=======
            args: [commonAb023dca_node.toMapValue(serializer, this.groups)]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
                commonAb023dca_node.toStringValue(this.distanceMeasure)
>>>>>>> main
            ]
        };
    }
...
=======
        commonAb023dca_node.hardAssert(!isNaN(limit) && limit !== Infinity && limit !== -Infinity, 0x882c);
>>>>>>> main
        super(options);
        this.limit = limit;
    }
...
=======
            args: [commonAb023dca_node.toNumber(serializer, this.limit)]
>>>>>>> main
        };
    }
}
...
=======
            args: [commonAb023dca_node.toNumber(serializer, this.offset)]
>>>>>>> main
        };
    }
}
...
=======
            args: [commonAb023dca_node.toMapValue(serializer, this.selections)]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
            args: [commonAb023dca_node.toNumber(serializer, this.rate), commonAb023dca_node.toStringValue(this.mode)]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
            args: [commonAb023dca_node.toPipelineValue(this.other._toProto(serializer))]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
            args: [this.map._toProto(serializer), commonAb023dca_node.toStringValue(Replace.MODE)]
>>>>>>> main
        };
    }
    _readUserData(context) {
...
=======
    if (commonAb023dca_node.isUserData(expressionMap)) {
>>>>>>> main
...
=======
        const options = commonAb023dca_node.isString(collectionOrOptions) ||
            commonAb023dca_node.isCollectionReference(collectionOrOptions)
            ? {}
            : collectionOrOptions;
        const collectionRefOrString = commonAb023dca_node.isString(collectionOrOptions) ||
            commonAb023dca_node.isCollectionReference(collectionOrOptions)
            ? collectionOrOptions
            : collectionOrOptions.collection;
        // Validate that a user provided reference is for the same Firestore DB
        if (commonAb023dca_node.isCollectionReference(collectionRefOrString)) {
            this._validateReference(collectionRefOrString);
        }
        // Convert user land convenience types to internal types
        const normalizedCollection = commonAb023dca_node.isString(collectionRefOrString)
>>>>>>> main
...
=======
        if (commonAb023dca_node.isString(collectionIdOrOptions)) {
>>>>>>> main
...
=======
            .filter(v => v instanceof commonAb023dca_node.DocumentReference)
            .forEach(dr => this._validateReference(dr));
        // Convert user land convenience types to internal types
        const normalizedDocs = docs.map(doc => commonAb023dca_node.isString(doc) ? doc : doc.path);
>>>>>>> main
        // Create stage object
...
=======
            throw new commonAb023dca_node.FirestoreError(commonAb023dca_node.Code.INVALID_ARGUMENT, `Invalid ${reference instanceof commonAb023dca_node.CollectionReference
>>>>>>> main
                ? 'CollectionReference'
                : 'DocumentReference'}. ` +
...
=======
        const value = this._fields.field(commonAb023dca_node.fieldPathFromArgument('DocumentSnapshot.get', fieldPath));
>>>>>>> main
        if (value !== null) {
...
=======
            commonAb023dca_node.fail(0x5319, { selectable });
        }
        if (result.get(alias) !== undefined) {
            throw new commonAb023dca_node.FirestoreError('invalid-argument', `Duplicate alias or field '${alias}'`);
>>>>>>> main
        }
...
=======
            throw new commonAb023dca_node.FirestoreError('invalid-argument', `Duplicate alias or field '${selectable.alias}'`);
>>>>>>> main
        }
...
=======
        const result = constant(commonAb023dca_node.vector(value));
>>>>>>> main
        return result;
    }
    else {
...
=======
        const options = isField(fieldValueOrOptions) || commonAb023dca_node.isString(fieldValueOrOptions)
            ? {}
            : fieldValueOrOptions;
        const fields = isField(fieldValueOrOptions) || commonAb023dca_node.isString(fieldValueOrOptions)
            ? [fieldValueOrOptions, ...additionalFields]
            : fieldValueOrOptions.fields;
        // Convert user land convenience types to internal types
        const convertedFields = fields.map(f => commonAb023dca_node.isString(f) ? field(f) : f);
>>>>>>> main
        // Create stage object
...
=======
        const options = isSelectable(selectionOrOptions) || commonAb023dca_node.isString(selectionOrOptions)
            ? {}
            : selectionOrOptions;
        const selections = isSelectable(selectionOrOptions) || commonAb023dca_node.isString(selectionOrOptions)
>>>>>>> main
...
=======
        if (commonAb023dca_node.isNumber(offsetOrOptions)) {
>>>>>>> main
            options = {};
            offset = offsetOrOptions;
        }
...
=======
        const options = commonAb023dca_node.isNumber(limitOrOptions) ? {} : limitOrOptions;
        const limit = commonAb023dca_node.isNumber(limitOrOptions)
>>>>>>> main
            ? limitOrOptions
...
=======
        const options = commonAb023dca_node.isString(groupOrOptions) || isSelectable(groupOrOptions)
            ? {}
            : groupOrOptions;
        const groups = commonAb023dca_node.isString(groupOrOptions) || isSelectable(groupOrOptions)
>>>>>>> main
...
=======
        const options = commonAb023dca_node.isString(valueOrOptions) || isExpr(valueOrOptions) ? {} : valueOrOptions;
        const fieldNameOrExpr = commonAb023dca_node.isString(valueOrOptions) || isExpr(valueOrOptions)
>>>>>>> main
            ? valueOrOptions
            : valueOrOptions.map;
        // Convert user land convenience types to internal types
...
=======
        const options = commonAb023dca_node.isNumber(documentsOrOptions) ? {} : documentsOrOptions;
        let rate;
        let mode;
        if (commonAb023dca_node.isNumber(documentsOrOptions)) {
            rate = documentsOrOptions;
            mode = 'documents';
        }
        else if (commonAb023dca_node.isNumber(documentsOrOptions.documents)) {
>>>>>>> main
...
=======
        if (commonAb023dca_node.isString(indexFieldName)) {
>>>>>>> main
...
=======
    const datastore = commonAb023dca_node.getDatastore(pipeline._db);
    const udr = new commonAb023dca_node.UserDataReader(pipeline._db._databaseId, 
>>>>>>> main
...
=======
    return commonAb023dca_node.invokeExecutePipeline(datastore, structuredPipeline).then(result => {
>>>>>>> main
...
=======
            ? new commonAb023dca_node.DocumentReference(pipeline._db, null, element.key)
>>>>>>> main
...
=======
commonAb023dca_node.Firestore.prototype.pipeline = function () {
    const userDataWriter = new commonAb023dca_node.LiteUserDataWriter(this);
    const userDataReader = commonAb023dca_node.newUserDataReader(this);
>>>>>>> main
