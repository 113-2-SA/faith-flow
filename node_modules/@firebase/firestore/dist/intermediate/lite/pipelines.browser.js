...
=======
import { O as e, av as t, aw as n, ax as r, g as s, s as i, ay as o, az as a, af as u, j as _, aA as l, aB as c, aq as p, am as E, aC as f, aD as T, aE as d, M as h, aF as x, aG as A, w as P, aH as V, aI as I, aJ as R, aK as g, aL as m, I as w, C as $, J as v, aM as D, f as F, aN as O, aO as y, F as U, i as b, k as S } from "./common-4ca7d0e8.browser.js";
>>>>>>> main
...
=======
    n = T(e) ? t.pipeline().collectionGroup(e.collectionGroup) : d(e) ? t.pipeline().documents([ h(t, e.path.canonicalString()) ]) : t.pipeline().collection(e.path.canonicalString());
    // filters
        for (const t of e.filters) n = n.where(__PRIVATE_toPipelineBooleanExpr(t));
    // orders
        const r = x(e), s = r.map((e => field(e.field.canonicalString()).exists()));
