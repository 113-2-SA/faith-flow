...
=======
import { b4 as e, l as t, b5 as n, b6 as r, au as s, d as i, b7 as o, b8 as a, b9 as u, aR as _, aQ as l, ba as c, t as E, bb as p, ad as f, q as T, o as d, a1 as x, C as h, bc as A, bd as P, be as V, bf as R, bg as I, D as m, m as g, aI as w, bh as $, aJ as v, bi as D, y as F, F as y, z as b, bj as O, bk as U, bl as S, bm as C, f as M, H as q } from "./common-cd010f05.rn.js";

export { bn as _internalPipelineToExecutePipelineRequestProto } from "./common-cd010f05.rn.js";
>>>>>>> main
...
=======
        const r = T(e), s = r.map((e => field(e.field.canonicalString()).exists()));
...
=======
        r.filter((e => e instanceof m)).forEach((e => this._validateReference(e)));
>>>>>>> main
        // Convert user land convenience types to internal types
...
=======
        if (!n.isEqual(this.databaseId)) throw new t(g.INVALID_ARGUMENT, `Invalid ${e instanceof w ? "CollectionReference" : "DocumentReference"}. The project ID ("${n.projectId}") or the database ("${n.database}") does not match the project ID ("${this.databaseId.projectId}") and database ("${this.databaseId.database}") of the target database of this Pipeline.`);
>>>>>>> main
    }
}
...
=======
        const t = e.length > 0 ? e[0].executionTime?.toTimestamp() : void 0, r = e.filter((e => !!e.fields)).map((e => new PipelineResult(n._userDataWriter, e.fields, e.key?.path ? new m(i, null, e.key) : void 0, e.createTime?.toTimestamp(), e.updateTime?.toTimestamp())));
>>>>>>> main
