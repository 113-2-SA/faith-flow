...
// begin-report-data
{"diagnostics":[{"locations":[{}],"problem":[{"text":"Configuring project ':packages' without an existing directory is deprecated. The configured projectDirectory 'D:\\faith-flow\\node_modules\\react-native\\tmp' does not exist, can't be written to or is not a directory. This behavior has been deprecated."}],"severity":"WARNING","problemDetails":[{"text":"This will fail with an error in Gradle 9.0."}],"contextualLabel":"Configuring project ':packages' without an existing directory is deprecated. The configured projectDirectory 'D:\\faith-flow\\node_modules\\react-native\\tmp' does not exist, can't be written to or is not a directory. This behavior has been deprecated.","documentationLink":"https://docs.gradle.org/8.14/userguide/upgrading_version_8.html#deprecated_missing_project_directory","problemId":[{"name":"deprecation","displayName":"Deprecation"},{"name":"configuring-project-packages-without-an-existing-directory-is-deprecated-the-configured-projectdirectory-d-faith-flow-node-modules-react-native-tmp-does-not-exist-can-t-be-written-to-or-is-not-a-directory-this-behavior-has-been-deprecated","displayName":"Configuring project ':packages' without an existing directory is deprecated. The configured projectDirectory 'D:\\faith-flow\\node_modules\\react-native\\tmp' does not exist, can't be written to or is not a directory. This behavior has been deprecated."}],"solutions":[[{"text":"Make sure the project directory exists and can be written."}]]},{"locations":[{}],"problem":[{"text":"Configuring project ':packages:react-native' without an existing directory is deprecated. The configured projectDirectory 'D:\\faith-flow\\node_modules\\react-native\\tmp' does not exist, can't be written to or is not a directory. This behavior has been deprecated."}],"severity":"WARNING","problemDetails":[{"text":"This will fail with an error in Gradle 9.0."}],"contextualLabel":"Configuring project ':packages:react-native' without an existing directory is deprecated. The configured projectDirectory 'D:\\faith-flow\\node_modules\\react-native\\tmp' does not exist, can't be written to or is not a directory. This behavior has been deprecated.","documentationLink":"https://docs.gradle.org/8.14/userguide/upgrading_version_8.html#deprecated_missing_project_directory","problemId":[{"name":"deprecation","displayName":"Deprecation"},{"name":"configuring-project-packages-react-native-without-an-existing-directory-is-deprecated-the-configured-projectdirectory-d-faith-flow-node-modules-react-native-tmp-does-not-exist-can-t-be-written-to-or-is-not-a-directory-this-behavior-has-been-deprecated","displayName":"Configuring project ':packages:react-native' without an existing directory is deprecated. The configured projectDirectory 'D:\\faith-flow\\node_modules\\react-native\\tmp' does not exist, can't be written to or is not a directory. This behavior has been deprecated."}],"solutions":[[{"text":"Make sure the project directory exists and can be written."}]]}],"problemsReport":{"totalProblemCount":2,"buildName":"react-native-build-from-source","requestedTasks":"","documentationLink":"https://docs.gradle.org/8.14/userguide/reporting_problems.html","documentationLinkCaption":"Problem report","summaries":[]}}
// end-report-data
);}
</script>
                <script type="text/javascript">
